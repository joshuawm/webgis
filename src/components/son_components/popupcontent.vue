<template>
  <div id="godDamn">
    <div class="popup">
      <div class="basicinfos">
        ...
        <el-row>
          <el-col :span="24">
            ...
            <el-row>
              <el-col :span="16">
                <p class="cityy" v-if="info.city !== undefined">
                  {{ info.city }}
              ...
              <el-col :span="8">
                <el-button type="text" @click="addFavorite">{{ buttonactive.FavoriteActive }}</el-button>
              </el-col>
            </el-row>
      ...
      <div class="moreinfos" v-if="more">
        <template v-if="attractionmore">
          ...
          <el-scrollbar style="text-align:left; margin:1px 1px; height: 150px; width: 90%;" tag="span">
            <span>{{ moreContentCom }}</span></el-scrollbar>
      ...
      <div v-if="popupInfo.typ==='attractions'">
        <el-row>
          <el-col :span="4">
            <el-button @click="moreinfo" type="text">{{ moreText }}</el-button>
          </el-col>
          <el-col :span="4">
            <el-button @click="get_caterings(popupInfo.id)" type="text">美食</el-button>
          </el-col>
          <el-col :span="4">
            <el-button @click="get_hotels(popupInfo.id)" type="text">酒店</el-button>
          </el-col>
    ...
    <div v-if="openComment" class="comment">
      ...
      <!--      <el-input type="textarea" :rows="2" placeholder="说些什么吧" v-model="commentContent"></el-input>-->
      <!--      <br>-->
