  ...
  <div id="godDamn">
    <div class="popup">
        ...
        <el-row>
          <el-col :span="24">
            ...
            <el-row>
              ...
              <!-- 垃圾button 太大放不下 -->
              <!-- <el-col :span="14"><el-button class="favor" size="mini" type="warning" icon="el-icon-star-off" circle @click="Favorite(poiID)"></el-button></el-col> -->
      ...
      <el-row>
        ...
        <el-col :span="4"><el-button @click="get_caterings(popupInfo.id)" type="text">美食</el-button></el-col>
        <el-col :span="4"><el-button @click="get_hotels(popupInfo.id)" type="text">酒店</el-button></el-col>
<!--        <el-col :span="4" ><el-button type="text" @click="openComment= !openComment">评论</el-button></el-col>-->
      </el-row>

  </div>
    <div v-if="openComment" class="comment">
      <span>输入你对景点的看法吧!!!</span><br>
      <el-rate v-model="ratting" :colors="colors"></el-rate>
      <textarea style="width: 90%" v-model="commentContent"></textarea><br>
      <button class="commentSubmitButton" @click="commentSubmit">提交</button>
...
let comments=[
  {
    name:"Joshua",
    rating:5,
    content:'我们是疫情结束以后去的武汉，黄鹤楼是武汉的地标景点，当然要去！去了以后免票，很感动，武汉市政府为了答谢全国人民在疫情期间援助武汉，特此对外免票！英雄的城市，千古的黄鹤楼，果然名不虚传！来武汉一定要去黄鹤楼'
  },
  {
    name:"云淡风轻",
    rating: 3,
    content: "众所周知的“武汉必游景点”黄鹤楼，主体是1980年代重新修造的钢筋水泥建筑。在1880年代到1980年代的百年间，武汉并不存在一座“黄鹤楼”建筑。而在此之前存在于此地，为纪念张之洞而修造的奥略楼，以及其原址上兴建的近代建筑【警钟楼】，在很大程度上起到了替代作用，并在那个年代的游人自欺欺人的张冠李戴成了黄鹤楼的等价品。只不过这段历史，即便是“老武汉”也不大清爽了。"
  },
  {
    name:"xiaoxiao",
    rating: 5,
    content: "去武汉黄鹤楼是必游景点，登上黄鹤楼可以看到武汉的全景，很是漂亮。我们是白天登上黄鹤楼的，如果晚上去看夜景应该还要漂亮，没有看到夜景有点遗憾……"
  }
]
...
export default {
  ...
  methods:{
    async getInfo(poiID){
      ...
      if(this.popupInfo.type="attractions"){
      ...
      }else if(this.popupInfo.type="caterings"){
        ...
        queryword="catering"
      }else if(this.popupInfo.type="hotels"){
